...
import net.hardcodes.neuroid.net.Adaline;
import net.hardcodes.neuroid.net.BAM;
import net.hardcodes.neuroid.net.CompetitiveNetwork;
import net.hardcodes.neuroid.net.Hopfield;
import net.hardcodes.neuroid.net.Instar;
import net.hardcodes.neuroid.net.Kohonen;
import net.hardcodes.neuroid.net.MaxNet;
import net.hardcodes.neuroid.net.MultiLayerPerceptron;
import net.hardcodes.neuroid.net.Outstar;
import net.hardcodes.neuroid.net.Perceptron;
import net.hardcodes.neuroid.net.RBFNetwork;
import net.hardcodes.neuroid.net.SupervisedHebbianNetwork;
import net.hardcodes.neuroid.net.UnsupervisedHebbianNetwork;
...
import net.hardcodes.neuroid.net.learning.DynamicBackPropagation;
import net.hardcodes.neuroid.net.learning.MomentumBackpropagation;
import net.hardcodes.neuroid.net.learning.PerceptronLearning;
import net.hardcodes.neuroid.net.learning.ResilientPropagation;
