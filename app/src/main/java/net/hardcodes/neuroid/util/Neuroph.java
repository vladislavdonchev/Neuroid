...
public class Neuroph {
	...
	public void shutdown() {
        ...
        public ArrayList<String> getInputFunctions() {
           try {
                ArrayList classes =  Neuroph.getClassNamesFromPackage("net.hardcodes.neuroid.core.input");
        ...
        public ArrayList<String> getTransferFunctions() {
           try {
                ArrayList classes =  Neuroph.getClassNamesFromPackage("net.hardcodes.neuroid.core.transfer");
        ...
        public ArrayList<String> getNeurons() {
           try {
                ArrayList classes =  Neuroph.getClassNamesFromPackage("net.hardcodes.neuroid.net.comp.neuron");
        ...
        public ArrayList<String> getLayers() {
           try {
                ArrayList classes =  Neuroph.getClassNamesFromPackage("net.hardcodes.neuroid.net.comp.layer");
                classes.add(0, "Layer");
                return classes;
            } catch (IOException ex) {
                Logger.getLogger(Neuroph.class.getName()).log(Level.SEVERE, null, ex);
        ...
        public ArrayList<String> getLearningRules() {
           try {
                ArrayList classes =  Neuroph.getClassNamesFromPackage("net.hardcodes.neuroid.net.learning");
                return classes;
            } catch (IOException ex) {
                Logger.getLogger(Neuroph.class.getName()).log(Level.SEVERE, null, ex);
                return null;
