...
import net.hardcodes.neuroid.imgrec.image.ImageFactory;
...
//	 */
//	public static ImageAndroid scanLocationUsingScreenshot(Robot robot,
//			Rectangle2D.Double rectangleAsDecimalPercent, Dimension samplingResolution)
//	{
//		return scanLocationUsingScreenshot(robot, rectangleAsDecimalPercent, samplingResolution, ImageAndroid.TYPE_INT_RGB);
//	}
//	
//	/**
//	 * Scans screen location using screenshot
...
//		ImageAndroid screenCapture = robot.createScreenCapture(screenRect);
//		
//		
...
//         */
//	public static ImageAndroid downSampleImage(
//			Dimension samplingResolution, ImageAndroid bigImg) {
//		return downSampleImage(samplingResolution, bigImg, ImageAndroid.TYPE_INT_RGB);
//	}
//
//
//        /**
...
//         * @return image scaled/downsampled to the specified dimension/resolution
//         */
//	public static ImageAndroid downSampleImage(Dimension samplingResolution,
//			ImageAndroid bigImg, int returnImageType) {
//		int inspectX;
//		int inspectY;
...
//		}
//		
//		ImageAndroid img = new ImageAndroid(
...
//	 * @return image sample from the specified location
//	 */
//	public static ImageAndroid scanLocationUsingSampling(Robot robot,
//			Rectangle2D.Double rectangleAsDecimalPercent, Dimension samplingResolution)
//	{
//		return scanLocationUsingSampling(robot, rectangleAsDecimalPercent, samplingResolution, ImageAndroid.TYPE_INT_RGB);
//	}
//	
//	/**
//	 * Scans screen location using sampling
