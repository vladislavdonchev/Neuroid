...
public class EdgeDetection implements ImageFilter,Serializable {
    ...
    int width;
    int height;
    transient  ImageAndroid  originalImage;
    transient ImageAndroid filteredImage;
    ...
    public ImageAndroid processImage(ImageAndroid image) {
        ...
        for (int y = 1; y < height - 1; y++) {
            for (int x = 1; x < width - 1; x++) {
                ...
                filteredImage.setRGB(x, y, grayscale.getColor());
    ...
    private void setAttributes(ImageAndroid image) {
