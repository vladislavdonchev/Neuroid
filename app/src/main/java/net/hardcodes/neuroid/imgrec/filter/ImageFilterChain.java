...
public class ImageFilterChain implements ImageFilter, Serializable {
    ...
    public ImageAndroid processImage(ImageAndroid image) {
        ...
        ImageAndroid tempImage = image;
        for (ImageFilter filter : filters) {
            ImageAndroid filteredImage = filter.processImage(tempImage);
     ...
     * @return 
     */
    public List<FilteredImage> processImageTest(ImageAndroid image){
        List<FilteredImage> list = new ArrayList<FilteredImage>();
        ImageAndroid tempImage = image;
        for (ImageFilter filter : filters) {
            ImageAndroid processedImage = filter.processImage(tempImage);
