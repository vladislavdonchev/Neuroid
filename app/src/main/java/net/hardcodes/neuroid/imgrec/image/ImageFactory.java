...
public class ImageFactory {
    ...
    private static final String IMAGE_ANDROID_CLASS_NAME = "net.hardcodes.neuroid.imgrec.image.ImageAndroid";
    private static final String IMAGE_J2SE_CLASS_NAME = "net.hardcodes.neuroid.imgrec.image.ImageAndroid";
    ...
    public static Image createImage(Image bigImage, Integer width, Integer height, Integer imageType) {
        try {
